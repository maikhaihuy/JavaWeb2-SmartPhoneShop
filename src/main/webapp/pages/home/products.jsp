	...
	<div class="header">
		...
		<div class="container">
			<div class="h_menu4">
				...
				<ul class="nav">
					<li class="active"><a href="home.do?action=index"><i> </i>Desktops</a></li>
			...
			<div class="products">
					...
					<c:forEach items="${ products }" var="product">
						...
						<div class="col-md-3 md-col top-products" >
							<div class="col-md">
								<a href="home.do?action=detailProduct&productId=${ product.getProductId() }" class="compare-in"><img  src="${ product.getImg() }" alt="" />
								<div class="compare">
								...
								<div class="top-content">
									<h5><a href="home.do?action=detailProduct&productId=${ product.getProductId() }"> ${ product.getProductName() } </a></h5>
									<div class="white">
										<a href="home.do?action=detailProduct&productId=${ product.getProductId() }" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
										<p class="dollar"><span class="in-dollar">$</span><span>${ product.getPrice() }</span></p>
