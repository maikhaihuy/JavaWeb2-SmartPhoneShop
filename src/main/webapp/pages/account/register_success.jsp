...
<body>
				...
				<div class="header-top-in">
					...
					<div class="header-in">
						<ul class="icon1 sub-icon1">
							...
							<c:if test="${user != null}">{
                                 <li><a href="home.do?action=index">Hi,
										${ user }</a></li>
							...
							<c:if test="${user == null}">
								...
								<li><a href="account.do?action=loadRegister">
										REGISTER</a></li>

                            }
                            </c:if>
							<li><div class="cart">
									<a href="#" class="cart-in"> </a> <span> <c:if
											test="${cart != null }">
											${cart.size() }
										</c:if>
									</span>
	...
	<div class="container">
		<div class="account">
			<h2 class="account-in">Regist success!</h2>
			<div>
			...
			<div>
				<a href="home.do?action=index">Home</a>
			</div>
		</div>
	</div>
	<!---->
